<template>
	<scroll-view scroll-y class="birthday-wrapper">
		<view class="birthday-wrapper-inner">
			<u-navbar placeholder leftIconSize="14" border bgColor="#1AC7CD" title="生日" @leftClick="close" leftText="返回">
			</u-navbar>
			...
			<view class="birthday-body">
				...
				<view class="memorial-add" @click="handleShowBirthdayInfo('add')">
					<u-icon name="plus" color="#1AC7CD" size="20"></u-icon>
					<text>添加生日</text>
				</view>
			</view>
		</view>
...
<script>
	...
	export default {
		data() {
			return {
				remindImgList: [
					require('@/static/images/days/提醒中_生日.png'),
