			...
			<u-row justify="flex-start">
				...
				<u-col textAlign="center" align="center" justify="center" span="3">
					<view class="u-custom-col col-info">
						<view class="choose">
							<image src="https://eden-life.net.cn:9000/cdn/mango/images/home/日历.png" style="width: 18px;height: 18px;"></image>
			...
			<u-row justify="flex-start">
				...
				<u-col textAlign="center" align="center" justify="center" span="3" @click="handleDelete">
					<view class="u-custom-col col-back">
						<image src="https://eden-life.net.cn:9000/cdn/mango/images/home/键盘回退.png" class="col-back"></image>
					</view>
				</u-col>
	...
	export default Vue.extend({
		data() {
			return {
				...
				pickIcon: 'https://eden-life.net.cn:9000/cdn/mango/images/home/礼物.png',
				inputNote: '',
				inputNum: '0',
				cache: '',
				editTag: '',
